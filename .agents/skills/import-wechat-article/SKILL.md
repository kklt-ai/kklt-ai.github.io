...
3. Inspect source metadata without writing project files:
...
7. Verify the result:
   ...
   The remote-image search must return no matches. Count Markdown image references and files, and confirm every `/blog/<slug>/...` reference exists under `public/`.
